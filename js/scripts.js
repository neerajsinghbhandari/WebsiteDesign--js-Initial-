...
var tabSelect = document.getElementsByClassName("single-tab");

for(var a = 0; a < tabSelect.length; a++)
{
  tabSelect[a].onclick = function() {
    var clickedValue = this.innerHTML;
    document.getElementById("box-text").innerHTML = aboutUs[clickedValue];
  
    for(var b = 0; b < tabSelect.length; b++)
    {
      tabSelect[b].style["background-color"] = unseletectedColor;
      tabSelect[b].style["font-weight"] = "normal";
    }
...
var ServTitle = document.getElementById("service-title");
var ServText = document.getElementById("service-text");
